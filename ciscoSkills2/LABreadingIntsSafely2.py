...
'''
def leyendo_int(min, max, entrada):
    ok = False
    while not ok:
        try:
...
min = int(input('Ingresa el inicio del rango: '))
max = int(input('Ingresa el termino del rango: '))
entrada = 'Ingresa el valor a buscar dentro del rango: '

valor_valido = leyendo_int(min, max, entrada)
print('El numero es: ', valor_valido)